...
|-----------|-----------|-----------|-----------|---------------|---------------|---------------|
| ![Welcome](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/welcome.png?raw=true) | ![Splash](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/splash.png?raw=true) | ![CPU Stats](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/cpu.png?raw=true) | ![RAM Stats](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/memory.png?raw=true) | ![Storage Stats](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/storage.png?raw=true) | ![Network Stats](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/network.png?raw=true) | ![Goodbye](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/static_goodbye.png?raw=true)

<br>

Also available as a stand alone service outside of Home Assistant which can be accessed from the core repository:

[rpi_i2c_oled](https://github.com/ccritix/rpi_i2c_oled)
<br>
<br>
...
![Exit](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/static_goodbye.png?raw=true)
![Welcome](https://github.com/ccritix/rpi_i2c_oled/blob/master/img/examples/welcome.png?raw=true)
